...
# train, test 폴더 경로
train_path = "E:/ECG/dataset/train"
test_path = "E:/ECG/dataset/val"
...
torch.save(best_acc_weights, "best_model_acc_weights_2.pth")
torch.save(best_f1_weights, "best_model_f1_weights_2.pth")
...
print("  ")
print(f"Highest Test F1 Score: {best_f1_score: .4f}%")
print(f"Average Test F1 Score: {avg_f1_score: .4f}%")
print(f"F1 Score Standard Deviation: {f1_score_std: .4f}")
