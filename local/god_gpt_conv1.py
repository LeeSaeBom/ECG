...
for epoch in range(num_epochs):
    ...
    STATUS          PORTS     NAMES
b19545df51f7   alpine                    "tail -f /dev/null"       4 minutes ago    Up 4 minutes              dummy
571db79b2c62   leesaebom/iiplab:latest   "/bin/sh -c 'python3…"   10 minutes ago   Up 10 minutes             inspiring_chatterjee
(base) iiplab@iiplab-PRIMERGY-RX2540-M5:~/Desktop/SB/ECG$ docker stop 571db79b2c62
571db79b2c62
(base) iiplab@iiplab-PRIMERGY-RX2540-M5:~/Desktop/SB/ECG$ ls
best_model_acc_weights.pth        customdataset_kfold_ecg.py
best_model_acc_weights_conv1.pth  ecg_fgam.py
best_model_acc_weights_conv2.pth  god_gpt_conv1_server.py
best_model_acc_weights_conv3.pth  god_gpt_conv2_sever.py
best_model_acc_weights_conv4.pth  god_gpt_conv3.py
best_model_f1_weights.pth         god_gpt_conv3_server.py
best_model_f1_weights_conv1.pth   god_gpt_conv4.py
best_model_f1_weights_conv2.pth   god_gpt_conv4_server.py
best_model_f1_weights_conv3.pth   test
best_model_f1_weights_conv4.pth   test.py
cnn1d.py                          train
confusion_matrix_kfold.py         val
customdataset_kfold.py
(base) iiplab@iiplab-PRIMERGY-RX2540-M5:~/Desktop/SB/ECG$ vi god_gpt_conv1_server.py
(base) iiplab@iiplab-PRIMERGY-RX2540-M5:~/Desktop/SB/ECG$ cat god_gpt_conv1_server.py
import os
import glob
import pandas as pd
import torch
...
torch.save(best_acc_weights, "best_model_acc_weights_conv1.pth")
torch.save(best_f1_weights, "best_model_f1_weights_conv1.pth")
